...
FILE_SOURCES	= push_swap.c del.c push.c print_node.c stack_load.c vec_load.c vec_unload.c quick_sort_vec.c # rotate.c rotate_rev.c rotate_sametime.c rotate_rev_sametime.c swap.c swap_sametime.c 
